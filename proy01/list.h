...
// Adds element 'e' to the start of list 'l'.
...
// Indicates if there are no elements in list 'l'.
...
// Discards first element of list 'l'.
...
// Concatenates list l with l2. The elements of 'l2' are copied into 'l'.
...
// Gets the n-nth element of list 'l'.
...
// Keeps the n first elements of list 'l' and destroy the rest of them.
...
// Drops (and destroys) the first n elements of list 'l'.
...
// Insert element 'e' to the n-nth position of list 'l'.
...
// Deletes the n-nth element of list 'l'.
...
// Returns a copy of the list 'l' with new memory.
...
// Destroy list 'l' by freeing all the allocated resources.
